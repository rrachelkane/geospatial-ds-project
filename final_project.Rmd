...
cb_all <- cb_all %>%
  left_join(start_points_sf %>% dplyr::select(start_station_name, start_in_cpz, start_tract_id, start_borough_name), by = "start_station_name") %>%
  left_join(end_points_sf %>% dplyr::select(end_station_name, end_in_cpz, end_tract_id, end_borough_name), by = "end_station_name")
